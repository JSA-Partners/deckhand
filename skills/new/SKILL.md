...
!`"${CLAUDE_PLUGIN_ROOT}/bin/deckhand" new context --idea "$source"`

What is printed above is the whole request; nothing needs reading again. When it says an issue
number is next's, say so in one sentence and stop.
